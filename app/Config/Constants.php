...
// DYNAMIC URL from Constants.php x App.php
...
$base = str_replace('\\', '', $base); // Script tambahan by gilang. karena kalo tidak ditambah ini, hasilnya http://sdm.rsemanuel.com\/struktural/.....
